...
class Command(BaseCommand):
    help = "Management command to push indexes to elasticsearch"
    ...
    def recreate_index(self):
        ...
        index_name = Course._meta.es_index_name
        ...
        indices_client.put_mapping(doc_type=Course._meta.es_type_name, body=Course._meta.es_mapping, index=index_name)


    def push_db_to_index(self):
        data = [
            self.convert_for_bulk(c, 'create') for c in Course.objects.all()
        ]
    ...
    def convert_for_bulk(self, django_object, action=None):
        ...
        # es_repr() method is defined in models.Course class
